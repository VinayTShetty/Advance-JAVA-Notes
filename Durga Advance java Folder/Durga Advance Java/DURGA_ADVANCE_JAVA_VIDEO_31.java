...
Important Point:-If we are trying to acesss that Empty ResultSet then we will get SQL exception.//Told by Durga.
...
select * from emp;
It gives 10 records.
so if we execute below querey
int rowCount=st.executeUpdate("select * from employees");
we will get 10 as result  when we print rowCount.
***************************-----END of--->2<--------***************************
Example=3
=========
NOTE:-
