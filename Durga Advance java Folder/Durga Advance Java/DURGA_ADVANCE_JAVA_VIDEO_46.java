...
String sqlQuery="insert into employees values("+eno+",'"+ename+"',"+esal+",'"+eaddr+"')";  //Here we need to add the single quote in the middle ,so we are using like this ---> "'"
...
If we are using '' for String then we have to use as '%s' .  // that is  single quote, percentage,s,percentage single quote.

%d -->Used for decimal values.
