TOPIC:-Durga Advance java (22:41)
--------
VIDEO NO=100
-----------
...
VIDEO COMPLETED=YES
-----------------
Stored Procedure Cursor Application 4,5,6.
...
cst.setFloat(1,6000); //For every IN paramerter we have to  provide value.
cst.registerOutParameter(2,OracleTypes.CURSOR); // Register OUT parameter.
***************************-----END of--->3<--------***************************
Example=4
=========
NOTE:-
